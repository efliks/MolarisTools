...
import sys, os, copy, collections, subprocess
sys.path.append (os.path.join (os.environ["HOME"], "devel", "MolarisTools"))

from MolarisTools import MopacInputFile, MopacOutputFile
...
for atomSerial, atom in enumerate (inputFile.atoms, 1):
    derivatives = (
        (
            ...
            atom.y            ,
            atom.z            ,
            os.path.join ("derivatives", "atom%02d_xp.mop" % atomSerial) ,
            ) ,
            ...
            atom.y            ,
            atom.z            ,
            os.path.join ("derivatives", "atom%02d_xm.mop" % atomSerial) ,
            ) ,
        ),
        ...
        (
            ...
            atom.y  +  delta  ,
            atom.z            ,
            os.path.join ("derivatives", "atom%02d_yp.mop" % atomSerial) ,
            ) ,
            ...
            atom.y  -  delta  ,
            atom.z            ,
            os.path.join ("derivatives", "atom%02d_ym.mop" % atomSerial) ,
            ) ,
        ),
        ...
        (
            ...
            atom.y            ,
            atom.z  +  delta  ,
            os.path.join ("derivatives", "atom%02d_zp.mop" % atomSerial) ,
            ) ,
            ...
            atom.y            ,
            atom.z  -  delta  ,
            os.path.join ("derivatives", "atom%02d_zm.mop" % atomSerial) ,
            ) ,
        ),
    )
